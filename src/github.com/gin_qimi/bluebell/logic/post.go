...
import (
	...
	"github.com/gin_qimi/bluebell/dao/redis"
...
func GetPostById(pid int64) (data *models.ApiPostDetail, err error) {
	...
	if err != nil {
		zap.L().Error("mysql.GetUserById(post.AuthorID) failed", zap.Int64("post.CommunityID", post.CommunityID), zap.Error(err))
		return
	}
	// 接口数据拼接
...
func GetPostList2(p *models.ParamPostList) (data []*models.ApiPostDetail, err error) {
	...
	// 返回的数据还要按照给定的id的顺序返回
	posts, err := mysql.GetPostListById(ids)
	if err != nil {
		return
	}
