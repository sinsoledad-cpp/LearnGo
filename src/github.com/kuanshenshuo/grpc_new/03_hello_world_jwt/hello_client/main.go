...
import (
	...
	pb "github.com/kuanshenshuo/grpc_new/03_hello_world_jwt/hello_server/proto"
...
func main() {
	// creds, _ := credentials.NewClientTLSFromFile("D:\\Code\\Go\\src\\github.com\\kuanshenshuo\\grpc_new\\01_hello_world\\key\\test.pem",
	// 	"*.kuangstudy.com")
