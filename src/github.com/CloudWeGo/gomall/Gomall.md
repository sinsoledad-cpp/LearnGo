...
linux 但是 成功(windows):`docker run --network host -p 8080 <image_id>`

失败:docker run -v .\app\frontend\conf:/opt/gomall/frontend/conf --network gomall_default --env-file ./app/frontend/.env -p 8080:8080 <image_id>
